  ...
  <div class="jumbotron">
   <fieldset>
    <legend>ユーザー登録</legend>
     ...
     <label><input type="radio" name="kanri_flg" value=<?= $result['kanri_flg'] ?> >一般社員<input type="radio" name="kanri_flg" value=<?= $result['kanri_flg'] ?>>管理者</label><br>
     <label><input type="radio" name="life_flg" value=<?= $result['life_flg'] ?> >退社<input type="radio" name="life_flg" value=<?= $result['life_flg'] ?>>入社</label><br>
